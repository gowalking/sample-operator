...
import (
	...
	daas "sample-operator/pkg/generated/informers/externalversions/daas"
...
func (f *sharedInformerFactory) Daas() daas.Interface {
	return daas.New(f, f.namespace, f.tweakListOptions)
}
